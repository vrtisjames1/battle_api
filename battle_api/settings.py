"""
Django settings for battle_api project.
...
SECRET_KEY = 'django-insecure-2(avf#!=d34g%g6mh%uzzrja2frhu*(s&h)jw+#s+@owfykmyi'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'battleapi.herokuapp.com']
...
WSGI_APPLICATION = 'battle_api.wsgi.application'
